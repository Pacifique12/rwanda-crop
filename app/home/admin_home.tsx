    ...
    return (
        <ScrollView style={styles.container}>
            ...
            <View style={styles.gridContainer}>
                ...
                <View style={styles.row}>
                <TouchableOpacity
                        onPress={() => router.push("/manages")} // Changed to push
                        style={styles.cardContainer}
                        accessibilityLabel="Navigate to Admin Screen"
                    >
                        <Ionicons name="person" size={40} color="#8BC34A" />
                        <Text style={styles.cardLabel}>Abakoresha App</Text>
                    </TouchableOpacity>
                    <TouchableOpacity
                        onPress={() => router.push("/addfile")} // Changed to push
                        style={styles.cardContainer}
                        accessibilityLabel="Navigate to Add file Screen"
                    >
                        <Ionicons name="book" size={40} color="#8BC34A" />
                        <Text style={styles.cardLabel}>Kongeraho infasha Nyigisho</Text>
                    </TouchableOpacity>
                </View>
                <View style={styles.row}>
                    <TouchableOpacity
